//
//	deprecated.h		Various compatibility utilities for the IKAROS project - all functions in this file are deprecated and should not be used in new code
//
// The code are here temporarily for documentation purposes 
//
