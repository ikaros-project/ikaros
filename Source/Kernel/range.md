...
An extension that leaves a dimension's definition unchanged also preserves its current cursor;
only dimensions whose bounds or increment change are reset for traversal of the expanded range.
