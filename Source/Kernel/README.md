...
`Source/ikaros.h` remains the compatibility umbrella for module code. Focused public declarations live in `kernel_types.h`, `parameter.h`, `component.h`, and `module.h`; these own common runtime constants, the parameter interface, the component/group interface, and the module registration interface respectively.
