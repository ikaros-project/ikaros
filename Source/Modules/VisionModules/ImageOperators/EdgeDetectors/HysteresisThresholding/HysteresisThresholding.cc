...
static InitClass init("HysteresisThresholding", &HysteresisThresholding::Create, "Source/Modules/VisionModules/ImageOperators/EdgeDetector/HysteresisThresholding/");
