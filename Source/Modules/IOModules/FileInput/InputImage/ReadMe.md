...
|:----|:-----------|:----|:-------------|
|filename|JPEG or PNG file to read. Use # for an unpadded sequence number or multiple hashes such as #### for a fixed-width zero-padded number. Escape a literal hash as \#.|string||
