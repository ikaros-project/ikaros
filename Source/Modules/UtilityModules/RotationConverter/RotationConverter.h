//
//	RotationConverter.h		This file is a part of the IKAROS project
//
...
{
public:
    static Module * Create(Parameter * p) { return new RotationConverter(p); }

    RotationConverter(Parameter * p) : Module(p) {}
