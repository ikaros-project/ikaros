//
//		Max.cc		This file is a part of the IKAROS project
//					Module that Maxs its inputs (and keeps its topology if possible)
//
...
Max::Init()
{
    ...
    {
        Notify(msg_fatal_error, "Module \"%s\" (Max): The input sizes must be equal: INPUT1 = [%d, %d] INPUT2 = [%d, %d]\n", GetName(), size1x, size1y, size2x, size2y);
        return;
    }
