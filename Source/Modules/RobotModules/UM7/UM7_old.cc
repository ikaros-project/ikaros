...
class UM7 : public Module
{
    ...
    void Init()
    {
        ...
        s = NULL;
        std::cout << "Opening serial port on " << port << std::endl;
    ...
    void Tick()
    {
        ...
        while (1) // Read data until buffer is empty
        {
            ...
            // std::cout << "Data length " << rx_length << std::endl;
            // std::cout << "Data: ";
            // for (int i = 0; i < rx_length; i++)
            // {
            //     std::cout << std::hex << (int)(unsigned char)rx_data[i] << " ";
            // }
            std::cout << std::endl;
            ...
            while (1)
            {
                ...
                std::cout << "Packet Adress " << (int)packet.Address << std::endl;
