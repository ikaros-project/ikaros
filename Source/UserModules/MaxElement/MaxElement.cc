//
//	MaxElement.cc		This file is a part of the IKAROS project
//
...
MaxElement::Tick()
{
    output_array[0] = max(input_array, input_array_size);
	if(debugmode)
	{
...
static InitClass init("MaxElement", &MaxElement::Create, "Source/UserModules/MaxElement/");
